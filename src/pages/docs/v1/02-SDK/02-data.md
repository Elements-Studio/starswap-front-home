...
This function fetches Starswap reserve data for a given token address on a given network.
...
- This function throws an error if the provided tokenAddress is not a token with a Starswap exchange.
...
| :---------------- | :------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tokenAddress      | `string`            | The checksummed address of a token with a Starswap exchange.                                                                                                                                                                            |
...
/*
{
  ...
  // details for the Starswap exchange of the passed token
  exchange: {
    chainId: 1,
