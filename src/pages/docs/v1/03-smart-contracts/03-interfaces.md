...
```solidity
interface StarswapFactoryInterface {
    // Public Variables
...
```python
contract StarswapFactoryInterface():
    # Create Exchange
...
```solidity
interface StarswapExchangeInterface {
    // Address of ERC20 token sold on this exchange
    function tokenAddress() external view returns (address token);
    // Address of Starswap Factory
...
```python
contract StarswapExchangeInterface():
    # Public Variables
