...
<Info>
Starswap V1, while still fully functional, is no longer under active development. Looking for <Link to='/docs/v2/'>V2 documentation</Link>?
</Info>

# Query Parameters

The Starswap front-end supports URL query parameters to allow for custom linking to the Starswap exchange. Users and developers can use these query parameters to link to the Starswap exchange with custom prefilled settings.
...
`https://app.starswap.xyz/#/swap?theme=dark&use=v1`
...
`https://app.starswap.xyz/#/swap?exactField=input&exactAmount=10&inputCurrency=0x0F5D2fB29fb7d3CFeE444a200298f468908cC942?use=v1`
...
`https://app.starswap.xyz/#/send?recipient=0x74Aa01d162E6dC6A657caC857418C403D48E2D77?use=v1`
...
`https://app.starswap.xyz/#/add-liquidity?ethAmount=2.34&token=0x42456D7084eacF4083f1140d3229471bbA2949A8&tokenAmount=300?use=v1`
...
`https://app.starswap.xyz/#/remove-liquidity?poolTokenAmount=1.23&use=v1`
...
`https://app.starswap.xyz/#/swap?use=v1&create-exchange?tokenAddress=0x0F5D2fB29fb7d3CFeE444a200298f468908cC942`
...
`https://app.starswap.xyz/#/swap/0x0F5D2fB29fb7d3CFeE444a200298f468908cC942?exactField=input&exactAmount=10&use=v1`
