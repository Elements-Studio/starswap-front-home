...
Alongside the Starswap community, the Starswap Labs team will continue to
monitor the efficacy of this metric and we welcome additional feedback.

# Liquidity Range Charts

Starswap v3 introduces the concept of Concentrated Liquidity — a major
...
Guide_](https://help.starswap.xyz/en/articles/5391541-providing-liquidity-on-Starswap-v3).

# Create Proposal

Starswap’s governance system requires participants to submit executable
...
The Starswap Protocol is global financial infrastructure, serving users
from all around the world.

To better support our international user base, the Starswap Interface now
...
[_Crowdin Starswap translations
hub_](https://crowdin.com/project/Starswap-interface). Anyone can improve
...
This week we launched the [_Starswap Help
Center_](https://help.starswap.xyz/) to address common questions and
issues that affect our users. We’ve also published a number of How To
guides, starting with an [_Optimism
collection_](https://help.starswap.xyz/en/collections/3033942-layer-2) to
...
Starswap Docs has received a fresh coat of paint!
...
[_Swap_](https://docs.starswap.xyz/protocol/guides/swaps/single-swaps)
and [_Flash
Swap_](https://docs.starswap.xyz/protocol/guides/flash-integrations/inheritance-constructors)
functions in v3.
...
Ansari, [_Will Price_](/will__price), Wario, reuptake
and the [_LP cafe discord_](https://discord.gg/UKm6BzkJ).

We want to keep hearing from you! As always, the Starswap Labs team can
