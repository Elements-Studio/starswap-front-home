---
title: 'Starswap on Optimism (Alpha launch)!'
date: '2021-07-13'
author: '🦄 '
featuredImage: ./banner.png
previewText: 'Starswap V3, the third iteration of the Starswap protocol, has been deployed to the Optimism mainnet!'
---

![](./swap.gif)

Almost two years after our [Unipig](https://unipig.exchange/) proof of concept, we are finally ready to announce the Alpha launch of Starswap v3 on the Optimistic Ethereum (OΞ) mainnet!
...
- **Select Assets:** Starswap v3 can support any ERC20 token on OΞ, but will offer a limited number of assets at launch (ETH, USDT, WBTC, DAI, SNX). More tokens will be bridged to Optimistic Ethereum over the coming days and weeks.
