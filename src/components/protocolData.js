...
const ProtocolData = () => {
  ...
  // const volume = globalData ? globalData?.StarswapFactory?.totalVolumeUSD : 100000000000
  const transactions = globalData ? globalData?.StarswapFactory?.txCount : 29000000
    ...
    <Numbers id="about" style={{ flexDirection: 'column' }}>
      <div style={{ display: 'flex', width: '100%', justifyContent: 'space-between', alignItems: 'center', margin: 0 }}>
        ...
        <BigNumbers>
          ...
          <SparkleGray />
          <span>106.04K</span>
          <p style={{ fontSize: '14px' }}>Volume</p>
        </BigNumbers>
        <BigNumbers>
          <span>5</span>
