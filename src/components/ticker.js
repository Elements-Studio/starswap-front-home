...
export default function Ticker() {
  ...
  if (data && oneDayResult) {
    ...
    UniStats.exchanges = [Number.parseFloat(data?.StarswapFactory?.pairCount), ' Total Pools']
  ...
  return (
    initialized && (
      <MarqueeWrapper href="https://Starswap.info/" className="ticker" data-speed="0.25" data-pausable="true">
        <div>
