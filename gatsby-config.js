...
module.exports = {
  siteMetadata: {
    ...
    author: `@Starswap`,
    menulinks: menu,
    siteUrl: `https://starswap.xyz`,
    repository: `https://github.com/Starswap/Starswap-org`,
  ...
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        ...
        theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/starswap_logo_blue.svg` // This path is relative to the root of the site.
      }
    },
    {
